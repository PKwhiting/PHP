...
function buildvehicleDisplay($item,$image,$thumbnails){
    ...
    foreach ($thumbnails as $thumbnail){
        $dv .= "<img src='$thumbnail[imgPath]' alt='Image of $item[invMake] $item[invModel] on phpmotors.com'>";
    }
    $dv .= "</div>";
    $dv .= "<div id='ih'>";
    $dv .= "<img src='$image[imgPath]' alt='Image of $item[invMake] $item[invModel] on phpmotors.com'>";
    $dv .= "</div><div id='stats'>";
