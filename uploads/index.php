...
switch ($action) {
    case 'upload':
        ...
        if($imageCheck){
        $message = '<p class="minimessage">An image by that name already exists.</p>';
        } elseif (empty($invId) || empty($imgName)) {
        $message = '<p class="minimessage">You must select a vehicle and image file for the vehicle.</p>';
        } else {
        ...
        if ($result) {
        $message = '<p class="minimessage">The upload succeeded.</p>';
        } else {
        $message = '<p class="minimessage">Sorry, the upload failed.</p>';
        }
        }
    ...
    case 'delete':
        ...
        if ($remove) {
        $message = "<p class='minimessage'>$filename was successfully deleted.</p>";
        } else {
        $message = "<p class='minimessage'>$filename was NOT deleted.</p>";
        }
    ...
    default:
        ...
        $imageDisplay = '<p class="minimessage">Sorry, no images could be found.</p>';
        }
